...
/* harmony import */ var _chat_inbox_chat_inbox_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./chat-inbox/chat-inbox.component */ "./src/app/chat-inbox/chat-inbox.component.ts");
/* harmony import */ var _insert_user_insert_user_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./insert-user/insert-user.component */ "./src/app/insert-user/insert-user.component.ts");
...
const routes = [
    { path: '', component: _insert_user_insert_user_component__WEBPACK_IMPORTED_MODULE_4__["InsertUserComponent"] },
    { path: 'chat', component: _chat_inbox_chat_inbox_component__WEBPACK_IMPORTED_MODULE_3__["ChatInboxComponent"] },
];
let AppRoutingModule = class AppRoutingModule {
};
AppRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forRoot(routes, { useHash: true, paramsInheritanceStrategy: 'always' })],
...
/* harmony import */ var _chat_inbox_chat_inbox_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chat-inbox/chat-inbox.component */ "./src/app/chat-inbox/chat-inbox.component.ts");
/* harmony import */ var _insert_user_insert_user_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./insert-user/insert-user.component */ "./src/app/insert-user/insert-user.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _chat_inbox_chat_inbox_component__WEBPACK_IMPORTED_MODULE_6__["ChatInboxComponent"],
            _insert_user_insert_user_component__WEBPACK_IMPORTED_MODULE_7__["InsertUserComponent"]
        ],
        imports: [
...
let ChatInboxComponent = class ChatInboxComponent {
    constructor(router, utilsService) {
        this.router = router;
    ...
    setupSocketConnection() {
        this.socket = Object(socket_io_client__WEBPACK_IMPORTED_MODULE_4__["io"])(SOCKET_ENDPOINT, { transports: ['websocket'] });
        ...
        this.socket.on('user-broadcast', (data) => {
            if (data) {
                console.log(data);
                this.userConnected = data;
            }
        });
        this.socket.on('on-typing-broadcast', (data) => {
            if (data) {
                console.log(data);
...
ChatInboxComponent.ctorParameters = () => [
...
ChatInboxComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./chat-inbox.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/chat-inbox/chat-inbox.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./chat-inbox.component.css */ "./src/app/chat-inbox/chat-inbox.component.css")).default]
    })
], ChatInboxComponent);
...
InsertUserComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-insert-user',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./insert-user.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/insert-user/insert-user.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./insert-user.component.css */ "./src/app/insert-user/insert-user.component.css")).default]
    })
], InsertUserComponent);
...
module.exports = __webpack_require__(/*! /Volumes/Extreme SSD/Progetti/chat-example/chat-example-frontend/src/main.ts */"./src/main.ts");
